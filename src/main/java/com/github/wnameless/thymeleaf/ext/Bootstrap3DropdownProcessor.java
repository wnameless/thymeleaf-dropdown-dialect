...
public class Bootstrap3DropdownProcessor extends AbstractElementModelProcessor {

  public Bootstrap3DropdownProcessor(String dialectPrefix,
  ...
  protected void doProcess(ITemplateContext context, IModel model,
    ...
    if (bsIcon == null && bsText == null && bsIconAppend == null) {
      ...
      model.insert(idx++, modelFactory.createText(" "));
    }
