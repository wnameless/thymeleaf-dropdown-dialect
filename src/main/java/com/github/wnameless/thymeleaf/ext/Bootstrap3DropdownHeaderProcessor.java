...
public class Bootstrap3DropdownHeaderProcessor
    extends AbstractElementModelProcessor {

  public Bootstrap3DropdownHeaderProcessor(String dialectPrefix,
  ...
  protected void doProcess(ITemplateContext context, IModel model,
    ...
    model.reset();
    model.add(modelFactory.createOpenElementTag("li", attr,
