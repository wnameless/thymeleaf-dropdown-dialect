...
public class Bootstrap4DropdownItemProcessor
    extends AbstractElementModelProcessor {

  public Bootstrap4DropdownItemProcessor(String dialectPrefix,
  ...
  protected void doProcess(ITemplateContext context, IModel model,
    ...
    if (attr.containsKey("class")) {
      attr.put("class", attr.get("class") + " " + "dropdown-item");
    } else {
      attr.put("class", "dropdown-item");
    }
