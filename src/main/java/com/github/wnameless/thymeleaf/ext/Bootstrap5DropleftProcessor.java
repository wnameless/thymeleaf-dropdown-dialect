...
public class Bootstrap5DropleftProcessor extends AbstractElementModelProcessor {

  public Bootstrap5DropleftProcessor(String dialectPrefix,
  ...
  protected void doProcess(ITemplateContext context, IModel model,
    ...
    model.replace(0,
        modelFactory.createOpenElementTag("div", "class", "dropstart"));
