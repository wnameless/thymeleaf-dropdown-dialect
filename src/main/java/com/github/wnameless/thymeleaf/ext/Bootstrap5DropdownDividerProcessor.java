...
public class Bootstrap5DropdownDividerProcessor
    extends AbstractElementModelProcessor {

  public Bootstrap5DropdownDividerProcessor(String dialectPrefix,
  ...
  protected void doProcess(ITemplateContext context, IModel model,
    ...
    model.reset();
    model.add(
        modelFactory.createOpenElementTag("hr", "class", "dropdown-divider"));
    model.add(modelFactory.createCloseElementTag("hr"));
  }
