...
public class Bootstrap4DroprightProcessor
    extends AbstractElementModelProcessor {

  public Bootstrap4DroprightProcessor(String dialectPrefix,
  ...
  protected void doProcess(ITemplateContext context, IModel model,
    ...
    model.replace(0,
        modelFactory.createOpenElementTag("div", "class", "dropright"));
